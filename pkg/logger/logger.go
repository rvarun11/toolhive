...
// NOTE: Log is a global logger that is being used temporarily for any global initializations within the app
// This has to be replaced by NewLogger entirely.
var Log *zap.SugaredLogger

func Initialize() {
	Log = NewLogger().Named("root")
}
